"""
═══════════════════════════════════════════════════════════════════════════════
FinText Alpha Vectorizer Python Client SDK — Synchronous Client
═══════════════════════════════════════════════════════════════════════════════
"""
...
class FinTextClient:
    """
    Synchronous Python Client for the FinText Alpha Vectorizer API.

    Handles authentication, token lifecycle, rate limit header tracking,
    request serialization, and structured response parsing.
    ...
    Args:
        ...
        transport: Optional custom HTTP transport (useful for mocking and unit testing).
    """
    ...
    def _ensure_authenticated(self) -> None:
        ...
        if not self.api_token and self.admin_token:
            self.get_token(user_id=self.auto_auth_user)
    ...
    def health(self) -> HealthResponse:
        """
        Check the API server health and operational status.
    ...
    def get_token(
        ...
        """
        Request a temporary JWT token from POST /auth/token.
        ...
        try:
            resp = self._client.post("/auth/token", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def sentiment(
        ...
        """
        Query point-in-time financial sentiment for a stock ticker.
        ...
        try:
            resp = self._client.get("/sentiment", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def batch_sentiment(
        ...
        """
        Query point-in-time financial sentiment for multiple stock tickers in a single batch request.
        ...
        try:
            resp = self._client.get("/sentiment/batch", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def sentiment_history(
        ...
        """
        Query historical sentiment time series for a stock ticker.
        ...
        try:
            resp = self._client.get("/sentiment/history", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def sentiment_feed(
        ...
        """
        Retrieve a consolidated stream of sentiment signals across multiple tickers and sectors.
        ...
        try:
            resp = self._client.get("/sentiment/feed", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def sentiment_anomalies(
        ...
        """
        Scan and detect statistically significant sentiment anomalies across universe or sector tickers.
        ...
        try:
            resp = self._client.get("/sentiment/anomalies", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def export_csv(
        ...
        """
        Export historical financial sentiment records as a streamed CSV string.
        ...
        try:
            resp = self._client.get("/export/csv", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def export_parquet(
        ...
        as a streamed Apache Parquet binary byte buffer.
        ...
        try:
            resp = self._client.get("/export/parquet", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def sector_sentiment(
        ...
        """
        Query aggregate financial sentiment metrics for a GICS sector over a date range.
        ...
        try:
            resp = self._client.get("/sentiment/sector", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def create_sentiment_revision(
        ...
        """
        Apply Slowly Changing Dimension Type 2 (SCD2) revision to a sentiment signal.
        ...
        try:
            resp = self._client.post("/sentiment/revision", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_sentiment_revisions(
        self,
        ticker: str,
    ) -> RevisionHistoryListResponse:
        """
        Inspect complete SCD Type 2 revision history and lineage for an asset.
        ...
        try:
            resp = self._client.get("/sentiment/revisions", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def spillovers(
        ...
        try:
            resp = self._client.get("/spillovers", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def spillover_matrix(
        ...
        """
        Query cross-asset lead-lag information spillover correlation matrix across multiple tickers.
        ...
        try:
            resp = self._client.get("/spillovers/matrix", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def options_iv(
        ...
        """
        Query options implied volatility (IV) and analytical Black-Scholes Greeks (Delta, Gamma, Theta, Vega, Rho).
        ...
        try:
            resp = self._client.get("/options/iv", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def unusual_options(
        ...
        """
        Scan options universe for unusual activity (high volume relative to open interest).
        ...
        try:
            resp = self._client.get("/options/unusual", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def usage_stats(
        ...
        try:
            resp = self._client.get("/usage/stats", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def event_study(
        ...
        """
        Execute an Event Study measuring Cumulative Abnormal Returns (CAR) around corporate events.
        ...
        try:
            resp = self._client.get("/events/study", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def recent_8k(
        ...
        """
        Query recent SEC Form 8-K unscheduled corporate disclosure events and classifications.
        ...
        try:
            resp = self._client.get("/events/8k", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def supply_chain_risk(
        ...
        """
        Evaluate upstream and downstream supply chain risk propagation and graph intelligence.
        ...
        try:
            resp = self._client.get("/risk/supply-chain", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def backtest(
        ...
        *,
        ...
        """
        Execute point-in-time quantitative alpha strategy backtest.
        ...
        try:
            resp = self._client.post("/backtest", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def symbol_map(
        ...
        """
        Resolve financial security identifiers across Ticker, FIGI, CUSIP, and ISIN.
        ...
        try:
            resp = self._client.get("/symbols/map", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def batch_sentiment(
        ...
        """
        Query Point-in-Time sentiment signals for multiple tickers or a saved universe.
    ...
    def create_universe(
        ...
        """
        Create a new custom security universe (watchlist).
        ...
        try:
            resp = self._client.post("/universes", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def list_universes(
        ...
        """
        List custom universes defined by the authenticated user.
        ...
        try:
            resp = self._client.get("/universes", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_universe(
        ...
        """
        Get a specific custom universe by UUID.
        ...
        try:
            resp = self._client.get(f"/universes/{universe_id.strip()}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def update_universe(
        ...
        try:
            resp = self._client.put(f"/universes/{universe_id.strip()}", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def delete_universe(
        ...
        """
        Delete a custom universe by UUID.
        ...
        try:
            resp = self._client.delete(f"/universes/{universe_id.strip()}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def create_transcript(
        ...
        """
        Upload and store an earnings call transcript with automated or custom sentiment scoring.
        ...
        try:
            resp = self._client.post("/transcripts", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def list_transcripts(
        ...
        """
        List earnings call transcript metadata with filtering and pagination.
        ...
        try:
            resp = self._client.get("/transcripts", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_transcript(
        ...
        """
        Retrieve a single earnings call transcript with full text by UUID.
        ...
        try:
            resp = self._client.get(f"/transcripts/{transcript_id.strip()}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def delete_transcript(
        ...
        """
        Delete an earnings call transcript by UUID.
        ...
        try:
            resp = self._client.delete(f"/transcripts/{transcript_id.strip()}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def market_regime(
        ...
        """
        Query macro market regime classification and underlying quantitative components.
        ...
        try:
            resp = self._client.get("/market/regime", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def return_correlation(
        ...
        """
        Compute the Pearson correlation matrix of daily stock returns across a universe.
        ...
        try:
            resp = self._client.get("/market/correlation", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def put_call_ratio(
        ...
        try:
            resp = self._client.get("/options/put-call-ratio", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def earnings_surprise(
        ...
        """
        Query detected earnings surprise events based on pre/post earnings sentiment displacement.
        ...
        try:
            resp = self._client.get("/events/earnings-surprise", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def insider_trading(
        ...
        """
        Query SEC Form 4 insider trading transactions and normalized conviction signal scores.
        ...
        try:
            resp = self._client.get("/events/insider-trading", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def sentiment_disagreement(
        ...
        """
        Query the sentiment disagreement index and multi-source dispersion metrics for a ticker.
        ...
        try:
            resp = self._client.get("/sentiment/disagreement", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def options_vol_surface(
        ...
        """
        Query the 2D options implied volatility surface grid across strikes and expirations.
        ...
        try:
            resp = self._client.get("/options/vol-surface", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def ma_rumors(
        ...
        supply chain relationships, and insider trading accumulation.
        ...
        try:
            resp = self._client.get("/events/ma-rumors", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def regulatory_filings(
        ...
        with standardized event categories and SEC EDGAR metadata.
        ...
        try:
            resp = self._client.get("/events/filings", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def export_parquet(
        ...
        """
        Export historical sentiment data (and optionally stock prices) in Apache Parquet format.
    ...
    def ws_url(self, ticker: Optional[str] = None, format: str = "json") -> str:
        """
        Generate the authenticated WebSocket connection URL.
    ...
    def create_checkout_session(
        ...
        *,
        ...
        try:
            resp = self._client.post("/billing/checkout", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def create_portal_session(
        ...
        *,
        ...
        try:
            resp = self._client.post("/billing/portal", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_subscription(self) -> SubscriptionResponse:
        ...
        try:
            resp = self._client.get("/billing/subscription", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def create_org(self, name: str) -> CreateOrgResponse:
        ...
        try:
            resp = self._client.post("/orgs", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def list_orgs(self) -> ListOrgsResponse:
        ...
        try:
            resp = self._client.get("/orgs", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_org(self, org_id: str) -> OrgDetailsResponse:
        """Get organization details including member roster.
        ...
        try:
            resp = self._client.get(f"/orgs/{org_id}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def invite_member(
        ...
        try:
            resp = self._client.post(f"/orgs/{org_id}/invites", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def update_member_role(
        ...
        try:
            resp = self._client.patch(f"/orgs/{org_id}/members/{user_id}", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def remove_member(self, org_id: str, user_id: str) -> RemoveMemberResponse:
        ...
        try:
            resp = self._client.delete(f"/orgs/{org_id}/members/{user_id}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def leave_org(self, org_id: str) -> LeaveOrgResponse:
        ...
        try:
            resp = self._client.post(f"/orgs/{org_id}/leave", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def select_org(self, org_id: str) -> SelectOrgResponse:
        """Select an organization as the active context, receiving a new JWT with org_id claim.
        ...
        try:
            resp = self._client.post(f"/orgs/{org_id}/select", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_ip_whitelist(self) -> ListIpWhitelistResponse:
        """Retrieve the active IP and CIDR whitelist entries for the current user.
        ...
        try:
            resp = self._client.get("/security/ip-whitelist", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def add_ip_whitelist(
        ...
        """Add an IP address or CIDR range to the access whitelist.
        ...
        try:
            resp = self._client.post("/security/ip-whitelist", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def delete_ip_whitelist(self, entry_id: str) -> DeleteIpWhitelistResponse:
        """Remove an IP whitelist entry by ID.
        ...
        try:
            resp = self._client.delete(f"/security/ip-whitelist/{entry_id.strip()}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def list_news_articles(
        ...
        """List news articles with metadata and 200-character preview snippets.
        ...
        try:
            resp = self._client.get("/news/articles", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_news_article(self, article_id: str) -> NewsArticleFull:
        """Retrieve full text content and detailed NLP signals for a specific news article.
        ...
        try:
            resp = self._client.get(f"/news/articles/{article_id.strip()}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def sentiment_entities(
        ...
        """Retrieve aggregated sentiment statistics across extracted financial named entities.
        ...
        try:
            resp = self._client.get("/sentiment/entities", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_audit_logs(
        ...
        *,
        ...
        """
        Query compliance audit logs with filtering and pagination.
        ...
        try:
            resp = self._client.get("/audit/logs", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def export_audit_logs(
        ...
        *,
        ...
        """
        Export compliance audit logs formatted as CSV or JSON.
        ...
        try:
            resp = self._client.get("/audit/export", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def create_api_key(self, name: Optional[str] = None) -> CreateApiKeyResponse:
        """
        Generate a new long-lived API key token.
        ...
        try:
            resp = self._client.post("/auth/api-keys", json=body, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def list_api_keys(self) -> ListApiKeysResponse:
        """
        List all active and rotating API keys owned by the authenticated user.
        ...
        try:
            resp = self._client.get("/auth/api-keys", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_api_key(self, api_key_id: str) -> ApiKeyItem:
        """
        Retrieve metadata and rotation status for a specific API key.
        ...
        try:
            resp = self._client.get(f"/auth/api-keys/{api_key_id.strip()}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def rotate_api_key(
        ...
        """
        Initiate zero-downtime rotation for an API key.
    ...
    def revoke_api_key(self, api_key_id: str) -> dict[str, Any]:
        ...
        try:
            resp = self._client.delete(f"/auth/api-keys/{api_key_id.strip()}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def search(
        ...
        try:
            resp = self._client.get("/search", headers=headers, params=params)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def sector_rotation(
        ...
        try:
            resp = self._client.get("/market/sector-rotation", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_digest_subscription(self) -> DigestSubscriptionResponse:
        """
        ...
        try:
            resp = self._client.get("/digest/subscription", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def create_digest_subscription(
        ...
        try:
            resp = self._client.post("/digest/subscription", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def delete_digest_subscription(self) -> DeleteDigestResponse:
        """
        ...
        try:
            resp = self._client.delete("/digest/subscription", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def trigger_digest(
        ...
        try:
            resp = self._client.post("/digest/trigger", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def list_kafka_topics(self) -> KafkaTopicsResponse:
        """
        ...
        try:
            resp = self._client.get("/stream/kafka/topics", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_kafka_credentials(
        ...
        try:
            resp = self._client.get("/stream/kafka/credentials", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def revoke_kafka_credentials(
        ...
        try:
            resp = self._client.delete(f"/stream/kafka/credentials/{cid_str}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_retention_policies(self) -> RetentionPoliciesResponse:
        """
        ...
        try:
            resp = self._client.get("/retention/policies", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def create_retention_policy(
        ...
        try:
            resp = self._client.post("/retention/policies", headers=headers, json=body)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def delete_retention_policy(
        ...
        try:
            resp = self._client.delete(f"/retention/policies/{pid_str}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def factor_exposure(
        ...
        """
        Compute multi-factor risk exposure regression report for a stock.
        ...
        try:
            resp = self._client.get("/risk/factor-exposure", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def esg_scores(
        ...
        keyword mentions, positive/negative ratios, and composite ESG ratings.
        ...
        try:
            resp = self._client.get("/esg/scores", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def bankruptcy_risk(
        ...
        """
        Compute quantitative bankruptcy risk score (0-100) and risk category for a stock ticker,
        ...
        try:
            resp = self._client.get("/risk/bankruptcy", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def fx_sentiment(
        ...
        try:
            resp = self._client.get("/fx/sentiment", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def commodity_sentiment(
        ...
        try:
            resp = self._client.get("/commodities/sentiment", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def crypto_sentiment(
        ...
        """
        Retrieve quantitative news sentiment analytics for major cryptocurrencies.
        ...
        try:
            resp = self._client.get("/crypto/sentiment", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def options_microstructure(
        ...
        try:
            resp = self._client.get("/options/microstructure", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def market_breadth(
        ...
        ratio, breadth index, and 52-week new highs/lows for a specified universe.
        ...
        try:
            resp = self._client.get("/market/breadth", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def create_polling_webhook(
        ...
        """
        Create a new custom polling webhook subscription.
        ...
        try:
            resp = self._client.post("/polling-webhooks", json=body, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def list_polling_webhooks(self) -> PollingWebhooksResponse:
        """
        List all custom polling webhook subscriptions for the authenticated user.
        ...
        try:
            resp = self._client.get("/polling-webhooks", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def delete_polling_webhook(self, webhook_id: str) -> DeletePollingWebhookResponse:
        """
        Delete a custom polling webhook subscription.
        ...
        try:
            resp = self._client.delete(f"/polling-webhooks/{webhook_id.strip()}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def create_chat_alert(
        ...
        """
        Create a new Telegram or Discord chat alert bot subscription.
        ...
        try:
            resp = self._client.post("/chat-alerts", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def list_chat_alerts(self) -> ChatAlertsResponse:
        """
        List all active chat alert bot subscriptions configured for the authenticated user.
        ...
        try:
            resp = self._client.get("/chat-alerts", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def delete_chat_alert(self, subscription_id: str) -> DeleteChatAlertResponse:
        """
        ...
        try:
            resp = self._client.delete(f"/chat-alerts/{subscription_id.strip()}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def credit_sentiment(
        self,
        ticker: str,
        lookback_days: int = 30,
    ) -> CreditSentimentResponse:
        """
        Retrieve corporate Credit Default Sentiment and multi-signal credit distress metrics.
        ...
        try:
            resp = self._client.get("/risk/credit-sentiment", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def backfill_sentiment(
        ...
        """
        Request historical news sentiment backfill for a given ticker and date window.
        ...
        try:
            resp = self._client.post("/sentiment/backfill", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def portfolio_optimize(
        ...
        """
        Compute optimal portfolio weights using Mean-Variance (Max Sharpe) or Risk Parity.
        ...
        try:
            resp = self._client.post("/portfolio/optimize", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def portfolio_factor_exposure(
        ...
        """
        Compute multi-factor risk exposure and attribution regression report for a portfolio.
        ...
        try:
            resp = self._client.post("/risk/portfolio-factor-exposure", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def create_retraining_job(
        ...
        """Create and trigger a new model retraining job.
        ...
        try:
            resp = self._client.post("/retraining/jobs", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def list_retraining_jobs(
        ...
        """List model retraining jobs with optional filtering and pagination.
        ...
        try:
            resp = self._client.get("/retraining/jobs", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_retraining_job(
        ...
        """Retrieve details and status for a specific model retraining job.
        ...
        try:
            resp = self._client.get(f"/retraining/jobs/{clean_id}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def cancel_retraining_job(
        ...
        """Cancel a pending or running model retraining job.
        ...
        try:
            resp = self._client.post(f"/retraining/jobs/{clean_id}/cancel", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def submit_fix_order(
        ...
        try:
            resp = self._client.post("/fix/order", json=body, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def list_fix_orders(
        ...
        try:
            resp = self._client.get("/fix/orders", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def cancel_fix_order(
        ...
        try:
            resp = self._client.post("/fix/cancel", json=body, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def list_dlq_events(
        ...
        """List and filter dead-letter queue (DLQ) failed events.
        ...
        try:
            resp = self._client.get("/dlq/events", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_dlq_event(
        ...
        """Retrieve full details and un-truncated payload of a DLQ event.
        ...
        try:
            resp = self._client.get(f"/dlq/events/{clean_id}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def reprocess_dlq_event(
        self,
        id: str,
    ) -> ReprocessDLQResponse:
        """Trigger immediate reprocessing for a failed DLQ event.
        ...
        try:
            resp = self._client.post(f"/dlq/events/{clean_id}/reprocess", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def purge_dlq_event(
        ...
        """Permanently purge a DLQ event from quarantine.
        ...
        try:
            resp = self._client.delete(f"/dlq/events/{clean_id}", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def sla_status(
        ...
        """Retrieve API latency percentiles and contractual SLA compliance performance report.
        ...
        try:
            resp = self._client.get("/sla/status", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def sla_latency(
        ...
        """Retrieve signal ingestion and processing pipeline latency metrics and SLA compliance report.
        ...
        try:
            resp = self._client.get("/sla/latency", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def activate_sandbox(self) -> SandboxStatusResponse:
        """
        Activate Sandbox simulation mode for the authenticated user session.
        ...
        try:
            resp = self._client.post("/sandbox/activate", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def deactivate_sandbox(self) -> SandboxStatusResponse:
        """
        Deactivate Sandbox simulation mode, reverting the user session back to live production pipelines.
        ...
        try:
            resp = self._client.post("/sandbox/deactivate", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_sandbox_status(self) -> SandboxStatusResponse:
        """
        Get the current Sandbox status, mock data catalog version, and supported mock endpoints.
        ...
        try:
            resp = self._client.get("/sandbox/status", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_provenance(
        ...
        """
        Retrieve granular data provenance and processing lineage history for a specific record.
    ...
    def trigger_anomaly_scan(self) -> AnomalyScanResponse:
        """
        ...
        try:
            resp = self._client.post("/anomaly-scan", headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def detect_language(
        ...
        try:
            resp = self._client.get("/language/detect", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_model_card(self) -> ModelCardResponse:
        """
        Retrieve the standardized Model Card and Lineage Governance Report.
        ...
        """
        try:
            resp = self._client.get("/model-card")
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def generate_alpha_report(
        ...
        """
        Generate an Alpha Signal Validation Backtest Report.
        ...
        try:
            resp = self._client.post("/signals/alpha-report", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def pit_replay(
        ...
        try:
            resp = self._client.get("/pit/replay", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def signal_quality_report(
        ...
        try:
            resp = self._client.post("/signals/quality-report", json=payload, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def pit_certificate(
        ...
        try:
            resp = self._client.get("/pit/certificate", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_provider_health(
        ...
        try:
            resp = self._client.get("/providers/health", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def get_model_validation(
        ...
        try:
            resp = self._client.get("/model-validation", params=params, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def list_keys(self) -> list[TenantKeyItem]:
    ...
    def rotate_key(self, key_id: str) -> TenantRotateKeyResponse:
    ...
    def revoke_key(self, key_id: str) -> TenantRevokeKeyResponse:
        ...
        try:
            resp = self._client.delete(endpoint, headers=headers)
        except httpx.RequestError as exc:
            raise FinTextConnectionError(f"Failed to connect to FinText API: {exc}") from exc
    ...
    def __enter__(self) -> FinTextClient:
        return self
